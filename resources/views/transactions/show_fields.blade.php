<div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <p><a href="/qrcodes/{{ $transaction->qrcode['id'] }}"><b>{{ $transaction->qrcode['product_name'] }} </b></a></p>
            </div>
            ...
            <div class="form-group">
                ...
                <p><a href="{{ $transaction->qrcode['product_url'] }}" class="btn btn-success btn-lg"> Return to Merchant Site </a></p>
            </div>
            @endif
</div>
